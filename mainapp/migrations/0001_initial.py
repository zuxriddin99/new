# Generated by Django 3.1.2 on 2021-02-18 15:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sd_volume_max', models.CharField(max_length=255, verbose_name='Максимальный объем встраивамо памяти')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mainapp.customer', verbose_name='Покупател')),
            ],
        ),
        migrations.AddField(
            model_name='cart',
